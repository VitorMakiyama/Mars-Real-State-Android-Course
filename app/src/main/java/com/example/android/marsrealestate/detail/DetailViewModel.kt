...
class DetailViewModel(marsProperty: MarsProperty, app: Application) : AndroidViewModel(app) {
    // Private mutable that we will change
    private val _selectedProperty = MutableLiveData<MarsProperty>()
    // Public immutable that will be exposed to the app
    ...
    // LivData Transformations updates the variable when LiveData is changed!
